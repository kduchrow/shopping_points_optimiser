...
def create_test_accounts():
    with app.app_context():
        ...
        if existing_contrib:
            ...
            contributor = User(username='contributor', email='contributor@example.com', role='contributor', status='active')
        ...
        if existing_user:
            ...
            user = User(username='testuser', email='testuser@example.com', role='user', status='active')
        ...
        if existing_viewer:
            ...
            viewer = User(username='viewer', email='viewer@example.com', role='viewer', status='active')
